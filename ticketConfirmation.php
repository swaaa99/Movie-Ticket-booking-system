...
<body>
	...
	$seatno=$_POST['seatnum'];

$time_now=mktime(date('h')+4,date('i')+30,date('s'));
$booked_date_time = date('d-m-Y H:i',$time_now);
...
//First input in database table
	if (!$dateExists) {
		$sql="INSERT INTO showOrder(showOrderId,date,timeslot,theater,movieName,seat,bookedseat)  VALUES ('','".$date."','". $time. "','".$theater."','".$movieName."',".'50'.",'".$seatno."');";
						...
						<div class=" col-md-8 col-lg-8 "> 
							<table class="table table-user-information">
								<tbody>
									...
									<tr>
										<td><strong>number seat booked</strong></td>
										<td><?php echo $seatno;?> </td>
									</tr>
									<tr>

										<td><strong>Ticket Price </strong></td>
										<td><?php echo $seatno*150;?>  </td>
									</tr>
									...
									<form action="seatReducing.php" method="post">
										...
										<input type="hidden" name="seatnum" value=<?php echo '"'.$seatno.'"'; ?>> 
